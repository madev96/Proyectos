                ...
                <div class='col-md-8'>
                    <div class='alert alert-warning text-center' role='alert'>
                        ...
                        <ul class='list-unstyled'>
                            ...
                            <li>- Aportar la <a href='#documentacion'>documentación necesaria</a>.</li>
...
function calcularPrecioTasa($result) {
    ...
    if ($tipoVehiculo == 'Moto') {
        ...
        if ($diffDias == 0 && $diffHoras <= 7) {
            ...
            // Obtenemos la fecha y hora actual para incluirla en el mensaje
            $fechaActualFormatted = date('d/m/Y \a \l\a\s H:i');
        
            $mensajeDespuesEuro = "<em>(Precio calculado para el día $fechaActualFormatted h.) </em>
                                    <br><br>
            ...
            $mensajeDespuesEuro = "<em>(Precio calculado para el día $fechaActualFormatted h.)</em>
                ...
                $mensajeDespuesEuro = "<strong>(Precio calculado para el día $fechaActualFormatted h.)</strong>
                                    <br><br>
