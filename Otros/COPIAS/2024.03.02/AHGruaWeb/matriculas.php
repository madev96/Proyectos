            ...
            <div class='row justify-content-center'>
                <div class='col-md-8'>
                    <div class='alert alert-success text-center' role='alert'>
                        ...
                        <br>
                        <p>El vehículo con la matrícula <strong>$matricula</strong> ha sido movido por la grúa municipal.</p>
    ...
    <div class='container'>
        <div class='row justify-content-center'>
            <div class='col-md-8'>
                <div class='alert alert-warning text-center' role='alert'>
                    <h3>¡Atención!</h3>
                    <p>No se proporcionó una matrícula válida en la solicitud.</p>
